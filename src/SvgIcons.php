...
namespace monachilada\svgicons;

use monachilada\svgicons\twigextensions\SvgIconsTwigExtension;
...
class SvgIcons extends Plugin
{
    ...
    public function init()
    {
        ...
        Craft::$app->view->registerTwigExtension(new SvgIconsTwigExtension());
