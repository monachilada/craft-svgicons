...
/**
 * SVG Icons en Translation
 *
 * Returns an array with the string to be translated (as passed to `Craft::t('svg-icons', '...')`) as
 ...
 */
return [
    'SVG Icons plugin loaded' => 'SVG Icons plugin loaded',
];
